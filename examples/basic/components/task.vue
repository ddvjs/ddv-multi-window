      ...
      <ul
        ...
        >
          ...
          <div class="tabTask-menu__handle">
            <div class="inline-block cursor-pointer" @click.stop="handleTask($event, 'openMasterWindow', id)">
              <i class="dmw-icon icon-new-window f14"></i>
            </div>
            <div v-if="process[id].refreshable!==false" class="inline-block cursor-pointer" @click="handleTask($event, 'refresh', id)">
              <i class="dmw-icon icon-refresh f14"></i>
            </div>
            <div v-if="process[id].closable!==false" class="inline-block cursor-pointer" @click="handleTask($event, 'remove', id)">
